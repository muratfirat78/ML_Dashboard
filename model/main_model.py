...
class MainModel:
    def __init__(self, online_version):
        ...
        self.tasks_data = [{'title': 'titanic test'
                            , 'description': 'todo',
                        ...
                        "type": "bool", 
                        "range": "False-True",
                        "difficulty": [('Data Cleaning',60), ('Data Translation',80),   ('Model Training', 30), ("Predictive Modeling", 30)]
                            , 'dataset': 'titanic.csv',
                             'subtasks': [
                            {'title': 'Data Cleaning', 'status': 'todo', 'subtasks': [
                                    ...
                                    {'status': 'todo', 'action': ['DataCleaning', 'Drop Column'
                                        ], 'value': ['Cabin', 'PassengerId', 'Pclass', 'SibSp', 'Parch', 'Ticket', 'Fare', 'Name'
                                        ], 'title': 'Drop Columns', 'description': 'Remove columns that are irrelevant or redundant for the model.', 'hints': [
                                            "Go to the Data Cleaning tab. Select the column(s), choose 'drop column', then click apply.", 'Drop the following column(s): Cabin, PassengerId, Pclass, SibSp, Parch, Ticket, Fare, Name.'
                                        ], 'applied_values': [], 'order': 1
                                    }
                            ...
                            {'title': 'Data Translation', 'status': 'todo', 'subtasks': [
                                    {'status': 'todo', 'action': ['DataProcessing', 'LabelEncoding'
                                            ...
                                            "Go to the Data Processing tab. Choose the column, select 'encoding', choose 'Label Encoding', then click apply.", 'Apply label encoding to Sex, Embarked.'
                                        ], 'applied_values': [], 'order': 1
                                    },
                            ...
                            {'title': 'Model Training', 'status': 'todo', 'subtasks': [
                                    ...
                                    {'status': 'todo', 'action': ['ModelDevelopment', 'ModelFinetuning'
                            ...
                            {'title': 'Predictive Modeling', 'status': 'todo', 'subtasks': [
                                    {'status': 'todo', 'action': ['ModelDevelopment', 'ModelPerformance'
                                        ], 'value': [], 'title': 'Model Training & Evaluation', 'description': 'Train a model and evaluate its performance.', 'hints': ['Go to the Predictive Modeling tab. Select the model type, adjust parameters if needed, then click train.', 'Train the model using the selected parameters and evaluate its performance.'
                                        ], 'applied_values': [], 'order': 1
                                    }
