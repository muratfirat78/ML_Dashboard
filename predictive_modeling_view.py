...
from predictive_modeling_manager import Train_Model
import settings

TrainedModels = []

def models_click(change):     
    global  trmodels,model_sumry,TrainedModels
...
def TrainModel(event): 
    global t4_models,t4_results,trmodels

    t4_results.value += 'Train Model...'+'\n'
 
    Train_Model(settings.prdtsk_lbl.value,t4_models.value,t4_results,trmodels)
    return

def get_predictive_modeling_tab():
    ...
    trmodels.observe(models_click, 'value')
