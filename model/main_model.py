...
class MainModel:
    def __init__(self, online_version):
        ...
        self.tasks_data = [{
                    ...
                    {'title': 'todo2', 'description': 'todo', 'mode': 'guided', 'model_metric': ('accuracy',
    0.8), 'data_size': 711, 'missing_values': 0, 'type': 'bool', 'range': 'False-True', 'difficulty': [('Data Cleaning',
        60), ('Data Translation',
        80), ('Data Transformation',
        80), ('Statistics',
        80), ('Model Training',
        80), ('Predictive Modeling',
        80)
    ], 'dataset': 'titanic.csv', 'subtasks': [
        {'title': 'Data Cleaning', 'status': 'todo', 'subtasks': [
                {'status': 'todo', 'action': ['DataCleaning', 'Drop Column'
                    ], 'value': ['Cabin', 'PassengerId', 'Pclass', 'Name', 'SibSp', 'Parch', 'Ticket', 'Fare'
                    ], 'title': 'Drop Columns', 'description': 'Remove columns that are irrelevant or redundant for the model.', 'hints': [
                        "Go to the Data Cleaning tab. Select the column(s), choose 'drop column', then click apply."
                    ], 'applied_values': [], 'order': 1
                },
                {'status': 'todo', 'action': ['DataCleaning', 'Replace-Median'
                    ], 'value': ['Age'
                    ], 'title': 'Replace Missing Values (Median)', 'description': 'Replace missing values in a column using the median.', 'hints': [
                        "Go to the Data Cleaning tab. Select the column, choose 'replace median', then click apply."
                    ], 'applied_values': [], 'order': 1
                },
                {'status': 'todo', 'action': ['DataCleaning', 'Remove-Missing'
                    ], 'value': ['Embarked'
                    ], 'title': 'Remove Rows with Missing Values', 'description': 'Remove rows that contain missing values in the column.', 'hints': [
                        "Go to the Data Cleaning tab. Select the column, choose 'remove missing', then click apply."
                    ], 'applied_values': [], 'order': 1
                }
            ], 'applied_values': [], 'order': 2
        },
        {'title': 'Data Translation', 'status': 'todo', 'subtasks': [
                {'status': 'todo', 'action': ['DataProcessing', 'LabelEncoding'
                        ...
                        "Go to the Data Processing tab. Choose the column, select 'encoding', choose 'Label Encoding', then click apply."
                    ], 'applied_values': [], 'order': 1
                },
                {'status': 'todo', 'action': ['DataProcessing', 'ConvertToBoolean'
                    ], 'value': ['Survived'
        ...
        {'title': 'Model Training', 'status': 'todo', 'subtasks': [
                ...
                {'status': 'todo', 'action': ['DataProcessing', 'Split'
                    ...
                    ], 'title': 'Train/Test Split', 'description': 'Split dataset into training and testing sets.', 'hints': ['Go to the Data Processing tab. Choose the column, assign the target, set the test ratio, then click split.'
                    ], 'applied_values': [], 'order': 2
                },
                {'status': 'todo', 'action': ['ModelDevelopment', 'ParameterFinetuning'
                    ], 'value': [
                        ['Logistic Regression']
                    ], 'title': 'Unknown Task', 'description': None, 'hints': [], 'applied_values': [], 'order': 3
                }
            ], 'applied_values': [], 'order': 7
        },
        {'title': 'Predictive Modeling', 'status': 'todo', 'subtasks': [
                {'status': 'todo', 'action': ['ModelDevelopment', 'ModelPerformance'
                    ], 'value': [
                        [('True-Positive',
                            56), ('False-Positive',
                            ...
                            86), ('False-Negative',
                            20), ('Accuracy',
                            0.797752808988764), ('Precision',
                            0.7777777777777778), ('Recall',
                            0.7368421052631579), ('ROCFPR', [0.,
                                0.15686275, 1.
                            ]), ('ROCTPR', [0.,
                                0.73684211, 1.
                            ]), ('data_size',
                            711), ('missing_values',
                            0), ('type', 'bool'), ('range', 'False-True')
                        ]
                    ], 'title': 'Model Training & Evaluation', 'description': 'Train a model and evaluate its performance.', 'hints': ['Go to the Predictive Modeling tab. Select the model type, adjust parameters if needed, then click train.'
                    ], 'applied_values': [], 'order': 1
                }
            ], 'applied_values': [], 'order': None
        }
    ]
},
{'title': 'todo3', 'description': 'todo', 'mode': 'monitored', 'model_metric': ('accuracy', 0.8), 'data_size': 711, 'missing_values': 0, 'type': 'bool', 'range': 'False-True', 'difficulty': [('Data Cleaning', 60), ('Data Translation', 80), ('Data Transformation', 0), ('Statistics', 0), ('Model Training', 0), ('Predictive Modeling', 0)], 'dataset': 'titanic.csv', 'subtasks': [{'title': 'Data Cleaning', 'status': 'todo', 'subtasks': [{'status': 'todo', 'action': ['DataCleaning', 'Drop Column'], 'value': ['Cabin', 'PassengerId', 'Name', 'SibSp', 'Parch', 'Ticket', 'Fare', 'Pclass'], 'title': 'Drop Columns', 'description': 'Remove columns that are irrelevant or redundant for the model.', 'hints': ["Go to the Data Cleaning tab. Select the column(s), choose 'drop column', then click apply.", 'Drop the following column(s): Cabin, PassengerId, Name, SibSp, Parch, Ticket, Fare, Pclass.'], 'applied_values': [], 'order': 1}, {'status': 'todo', 'action': ['DataCleaning', 'Replace-Median'], 'value': ['Age'], 'title': 'Replace Missing Values (Median)', 'description': 'Replace missing values in a column using the median.', 'hints': ["Go to the Data Cleaning tab. Select the column, choose 'replace median', then click apply.", 'Apply replace median to Age.'], 'applied_values': [], 'order': 1}, {'status': 'todo', 'action': ['DataCleaning', 'Remove-Missing'], 'value': ['Embarked'], 'title': 'Remove Rows with Missing Values', 'description': 'Remove rows that contain missing values in the column.', 'hints': ["Go to the Data Cleaning tab. Select the column, choose 'remove missing', then click apply.", 'Remove rows with missing values in Embarked.'], 'applied_values': [], 'order': 1}], 'applied_values': [], 'order': 2}, {'title': 'Data Translation', 'status': 'todo', 'subtasks': [{'status': 'todo', 'action': ['DataProcessing', 'LabelEncoding'], 'value': ['Embarked', 'Sex'], 'title': 'Label Encoding', 'description': 'Convert categorical columns into numeric codes.', 'hints': ["Go to the Data Processing tab. Choose the column, select 'encoding', choose 'Label Encoding', then click apply.", 'Apply label encoding to Embarked, Sex.'], 'applied_values': [], 'order': 1}, {'status': 'todo', 'action': ['DataProcessing', 'ConvertToBoolean'], 'value': ['Survived'], 'title': 'Convert to Boolean', 'description': 'Convert 1 and 0 values in the column to boolean (True/False).', 'hints': ["Go to the Data Processing tab. Choose the column, select 'Convert to Boolean', then click apply.", "Convert 'Survived' to boolean (True/False)."], 'applied_values': [], 'order': 1}], 'applied_values': [], 'order': 3}, {'title': 'Model Training', 'status': 'todo', 'subtasks': [{'status': 'todo', 'action': ['DataProcessing', 'AssignTarget'], 'value': ['Survived'], 'title': 'Assign Target Variable', 'description': 'Assign the column as the target variable for model training.', 'hints': ["Go to the Data Processing tab. Choose the column, select 'Assign Target', then click apply.", "Assign 'Survived' as the target column."], 'applied_values': [], 'order': 1}, {'status': 'todo', 'action': ['DataProcessing', 'Split'], 'value': ['20%'], 'title': 'Train/Test Split', 'description': 'Split dataset into training and testing sets.', 'hints': ['Go to the Data Processing tab. Choose the column, assign the target, set the test ratio, then click split.', 'Use a test ratio of 20% for splitting the dataset.'], 'applied_values': [], 'order': 2}, {'status': 'todo', 'action': ['ModelDevelopment', 'ParameterFinetuning'], 'value': [['Logistic Regression']], 'title': 'Parameter Finetuning', 'description': 'Optimize model performance by modifying the parameters of the model.', 'hints': ['Go to the Predictive Modeling tab. Select the model type, adjust parameters if needed, then click train.'], 'applied_values': [], 'order': 3}], 'applied_values': [], 'order': 7}, {'title': 'Predictive Modeling', 'status': 'todo', 'subtasks': [{'status': 'todo', 'action': ['ModelDevelopment', 'ModelPerformance'], 'value': [[('True-Positive', 56), ('False-Positive', 16), ('True-Negative', 86), ('False-Negative', 20), ('Accuracy', 0.797752808988764), ('Precision', 0.7777777777777778), ('Recall', 0.7368421052631579), ('ROCFPR', [0.        , 0.15686275, 1.        ]), ('ROCTPR', [0.        , 0.73684211, 1.        ]), ('data_size', 711), ('missing_values', 0), ('type', 'bool'), ('range', 'False-True')]], 'title': 'Model Training', 'description': 'Train a model and evaluate its performance.', 'hints': ["Train the model using the following parameters: [[('True-Positive', 56), ('False-Positive', 16), ('True-Negative', 86), ('False-Negative', 20), ('Accuracy', 0.797752808988764), ('Precision', 0.7777777777777778), ('Recall', 0.7368421052631579), ('ROCFPR', array([0.        , 0.15686275, 1.        ])), ('ROCTPR', array([0.        , 0.73684211, 1.        ])), ('data_size', 711), ('missing_values', 0), ('type', 'bool'), ('range', 'False-True')]]."], 'applied_values': [], 'order': 1}], 'applied_values': [], 'order': None}]},
{'title': 'PCA test', 'description': 'todo', 'mode': 'guided', 'model_metric': ('MSE', 0.0), 'data_size': 1279, 'missing_values': 0, 'type': 'float64', 'range': '2.74-4.01', 'difficulty': [('Data Cleaning', 60), ('Data Translation', 80), ('Data Transformation', 60), ('Statistics', 60), ('Model Training', 80), ('Predictive Modeling', 60)], 'dataset': 'Red Wine Quality.csv', 'subtasks': [{'title': 'Statistics', 'status': 'todo', 'subtasks': [{'status': 'todo', 'action': ['DataProcessing', 'PCA'], 'value': [['citric acid', 'volatile acidity'], ['total sulfur dioxide', 'free sulfur dioxide']], 'title': 'Dimensionality Reduction (PCA)', 'description': 'Apply Principal Component Analysis to reduce dimensionality.', 'hints': ["Go to the Data Processing tab. Choose the column(s), select 'feature extraction', choose 'PCA', then click 'Add PCA' and apply.", "Apply PCA to the following column(s): [['citric acid', 'volatile acidity'], ['total sulfur dioxide', 'free sulfur dioxide']]."], 'applied_values': [], 'order': 1}], 'applied_values': [], 'order': 5}, {'title': 'Model Training', 'status': 'todo', 'subtasks': [{'status': 'todo', 'action': ['DataProcessing', 'AssignTarget'], 'value': ['pH'], 'title': 'Assign Target Variable', 'description': 'Assign the column as the target variable for model training.', 'hints': ["Go to the Data Processing tab. Choose the column, select 'Assign Target', then click apply.", "Assign 'pH' as the target column."], 'applied_values': [], 'order': 1}, {'status': 'todo', 'action': ['DataProcessing', 'Split'], 'value': ['20%'], 'title': 'Train/Test Split', 'description': 'Split dataset into training and testing sets.', 'hints': ['Go to the Data Processing tab. Choose the column, assign the target, set the test ratio, then click split.', 'Use a test ratio of 20% for splitting the dataset.'], 'applied_values': [], 'order': 2}, {'status': 'todo', 'action': ['ModelDevelopment', 'ParameterFinetuning'], 'value': [['Decision Tree', 15, 3, 'gini']], 'title': 'Parameter Finetuning', 'description': 'Optimize model performance by modifying the parameters of the model.', 'hints': ['Go to the Predictive Modeling tab. Select the model type, adjust parameters if needed, then click train.', "Train the model using the following parameters: [['Decision Tree', 15, 3, 'gini']]."], 'applied_values': [], 'order': 3}], 'applied_values': [], 'order': 7}, {'title': 'Predictive Modeling', 'status': 'todo', 'subtasks': [{'status': 'todo', 'action': ['ModelDevelopment', 'ModelPerformance'], 'value': [[('MSE', 0.0089046875), ('MAE', 0.06140624999999998), ('RSquared', 0.5871302395721338), ('data_size', 1279), ('missing_values', 0), ('type', 'float64'), ('range', '2.74-4.01')]], 'title': 'Model Training', 'description': 'Train a model and evaluate its performance.', 'hints': [], 'applied_values': [], 'order': 1}], 'applied_values': [], 'order': None}]}
                    ]
